...
LAB4_TEST_MAKE_lab4(53, "-1 -2 >=", "-1 >= -2", 0);
LAB4_TEST_MAKE_lab4(54, "-1 -2 <=", "-1 <= -2", 0);
LAB4_TEST_MAKE_lab4(55, "-1 -2 <", "-1 < -2", 0);
...
void lab4_runTests(void)
{
	void(*tests[])(void) = {
		...
		LAB4_TEST_GETNAME(53),
		LAB4_TEST_GETNAME(54),
		LAB4_TEST_GETNAME(55)
	};
