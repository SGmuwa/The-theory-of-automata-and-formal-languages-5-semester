...
LAB1_TEST_MAKE(14, 0.0, "-.1", 4);
LAB1_TEST_MAKE(15, 100000.000200, "100 000 . 000 200", 0);
LAB1_TEST_MAKE(16, 1.1, "1.1", 0);

#define LAB1_TEST_COUNT 16 + 1
...
void lab1_test(void)
{
	void(*tests[LAB1_TEST_COUNT])(void) = {
		...
		LAB1_TEST_GETNAME(15),
		LAB1_TEST_GETNAME(16)
	};
